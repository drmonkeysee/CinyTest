    ...
    switch (testObject.expectedType) {
        ...
        case TAT_SMAX:
            switch (testObject.actualType) {
                ...
                case TAT_LONG_LONG:
                case TAT_SMAX:
                    ct_assertnotequal(get_integer_test_arg(testObject.expectedType, ARG_EXPECTED), get_integer_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_BOOL:
                case TAT_UCHAR:
                case TAT_USHORT:
                ...
                case TAT_ULONG_LONG:
                case TAT_UMAX:
                    ct_assertnotequal(get_integer_test_arg(testObject.expectedType, ARG_EXPECTED), get_uinteger_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_FLOAT:
                case TAT_DOUBLE:
                case TAT_LDOUBLE:
                    ct_assertnotequal(get_integer_test_arg(testObject.expectedType, ARG_EXPECTED), get_float_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_FCOMPLEX:
                case TAT_COMPLEX:
                case TAT_LCOMPLEX:
                    ct_assertnotequal(get_integer_test_arg(testObject.expectedType, ARG_EXPECTED), get_complex_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
            }
            break;
        case TAT_BOOL:
        ...
        case TAT_UMAX:
            switch (testObject.actualType) {
                ...
                case TAT_LONG_LONG:
                case TAT_SMAX:
                    ct_assertnotequal(get_uinteger_test_arg(testObject.expectedType, ARG_EXPECTED), get_integer_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_BOOL:
                case TAT_UCHAR:
                case TAT_USHORT:
                ...
                case TAT_ULONG_LONG:
                case TAT_UMAX:
                    ct_assertnotequal(get_uinteger_test_arg(testObject.expectedType, ARG_EXPECTED), get_uinteger_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_FLOAT:
                case TAT_DOUBLE:
                case TAT_LDOUBLE:
                    ct_assertnotequal(get_uinteger_test_arg(testObject.expectedType, ARG_EXPECTED), get_float_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_FCOMPLEX:
                case TAT_COMPLEX:
                case TAT_LCOMPLEX:
                    ct_assertnotequal(get_uinteger_test_arg(testObject.expectedType, ARG_EXPECTED), get_complex_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
            }
            break;
        case TAT_FLOAT:
        ...
        case TAT_LDOUBLE:
            switch (testObject.actualType) {
                ...
                case TAT_LONG_LONG:
                case TAT_SMAX:
                    ct_assertnotequal(get_float_test_arg(testObject.expectedType, ARG_EXPECTED), get_integer_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_BOOL:
                case TAT_UCHAR:
                case TAT_USHORT:
                ...
                case TAT_ULONG_LONG:
                case TAT_UMAX:
                    ct_assertnotequal(get_float_test_arg(testObject.expectedType, ARG_EXPECTED), get_uinteger_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_FLOAT:
                case TAT_DOUBLE:
                case TAT_LDOUBLE:
        ...
        case TAT_LCOMPLEX:
            switch (testObject.actualType) {
                ...
                case TAT_LONG_LONG:
                case TAT_SMAX:
                    ct_assertnotequal(get_complex_test_arg(testObject.expectedType, ARG_EXPECTED), get_integer_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_BOOL:
                case TAT_UCHAR:
                case TAT_USHORT:
                ...
                case TAT_ULONG_LONG:
                case TAT_UMAX:
                    ct_assertnotequal(get_complex_test_arg(testObject.expectedType, ARG_EXPECTED), get_uinteger_test_arg(testObject.actualType, ARG_ACTUAL));
                    break;
                case TAT_FLOAT:
                case TAT_DOUBLE:
                case TAT_LDOUBLE:
...
- (void)test_ctassertnotequal_ComparesEqual_IfSameIntegerTypes
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfDifferentIntegerTypes
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfNegativeIntegerValues
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfNegativeIntegerValuesWithDifferentTypes
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfZeroIntegerValues
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfZeroIntegerValuesWithDifferentTypes
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfLargestIntegerValue
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfSmallestIntegerValue
{
...
- (void)test_ctassertnotequal_ComparesNotEqual_IfDifferentIntegerValues
{
...
- (void)test_ctassertnotequal_ComparesNotEqual_IfDifferentIntegerValuesAndTypes
{
...
- (void)test_ctassertnotequal_ComparesNotEqual_ForMinAndMaxIntegerValues
{
    smx_values[ARG_EXPECTED] = INTMAX_MIN;
    smx_values[ARG_ACTUAL] = INTMAX_MAX;
    self.expectedType = TAT_SMAX;
...
- (void)test_ctassertnotequal_ComparesEqual_IfSameUnsignedIntegerTypes
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfDifferentUnsignedIntegerTypes
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfZeroUnsignedIntegerValues
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfZeroUnsignedIntegerValuesWithDifferentTypes
{
...
- (void)test_ctassertnotequal_ComparesEqual_IfLargestUnsignedIntegerValue
{
...
- (void)test_ctassertnotequal_ComparesNotEqual_IfDifferentUnsignedIntegerValues
{
...
- (void)test_ctassertnotequal_ComparesNotEqual_IfDifferentUnsignedIntegerValuesAndTypes
{
...
- (void)test_ctassertnotequal_ComparesNotEqual_ForMinAndMaxUnsignedIntegerValues
{
...
- (void)test_ctassertnotequal_FailsAssertion_IfIntegerAndUIntegerTypes
{
...
- (void)test_ctassertnotequal_FailsAssertion_IfIntegerAndFloatTypes
{
    i_values[ARG_EXPECTED] = 20;
...
- (void)test_ctassertnotequal_FailsAssertion_IfIntegerAndComplexTypes
{
    i_values[ARG_EXPECTED] = 20;
...
- (void)test_ctassertnotequal_FailsAssertion_IfUIntegerAndFloatTypes
{
...
- (void)test_ctassertnotequal_FailsAssertion_IfUIntegerAndComplexTypes
{
    ui_values[ARG_EXPECTED] = 20;
    dc_values[ARG_ACTUAL] = CMPLX(20, 0.0);
    self.expectedType = TAT_UINT;
...
- (void)test_ctassertnotequal_FailsAssertion_IfIntegerAndUIntegerIdenticalBitPattern
{
...
- (void)test_ctassertnotequal_FailsAssertion_IfIntegerAndFloatIdenticalBitPattern
{
...
- (void)test_ctassertnotequal_FailsAssertion_IfUIntegerAndFloatIdenticalBitPattern
{
...
- (void)test_ctassertnotequal_ComparesNotEqual_IfCharAndIntegerType
{
    c_values[ARG_EXPECTED] = 42;
...
- (void)test_ctassertnotequal_FiresAssertion_IfCharAndUIntegerTypes
{
