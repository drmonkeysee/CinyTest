...
static void inequality_test(void *context)
{
    ...
    case TAT_SMAX:
        ...
        case TAT_LONG_LONG:
        case TAT_SMAX:
            ct_assertnotequal(get_integer_test_arg(testObject.expectedType,
                                                   ARG_EXPECTED),
    ...
    case TAT_UMAX:
        ...
        case TAT_LONG_LONG:
        case TAT_SMAX:
            ct_assertnotequal(get_uinteger_test_arg(testObject.expectedType,
                                                    ARG_EXPECTED),
                              get_integer_test_arg(testObject.actualType,
                                                   ARG_ACTUAL));
            break;
    ...
    case TAT_LDOUBLE:
        ...
        case TAT_LONG_LONG:
        case TAT_SMAX:
            ct_assertnotequal(get_float_test_arg(testObject.expectedType,
                                                 ARG_EXPECTED),
                              get_integer_test_arg(testObject.actualType,
                                                   ARG_ACTUAL));
            break;
    ...
    case TAT_LCOMPLEX:
        ...
        case TAT_LONG_LONG:
        case TAT_SMAX:
            ct_assertnotequal(get_complex_test_arg(testObject.expectedType,
                                                   ARG_EXPECTED),
                              get_integer_test_arg(testObject.actualType,
                                                   ARG_ACTUAL));
            break;
