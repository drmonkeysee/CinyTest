...
@interface CTVersionOptionTests : CTAssertionTestBase

@end

static void test_case(void *context)
{
    CTVersionOptionTests *testObject = (__bridge CTVersionOptionTests *)(TestClass);
...
@implementation CTVersionOptionTests
