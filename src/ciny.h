...
{
    return (struct ct_version){6, 0, 0};
}
/**
...
/**
 Dummy argument for ct_run overloads requiring an empty argv array.
 */
extern const char *ct_EmptyArgv;
/**
 ...
 */
#define ct_run(suites) ct_run_withargs(suites, 0, &ct_EmptyArgv)
/**
 ...
 */
inline size_t ct_runsuite_withargs(const struct ct_testsuite suite[static 1], int argc, const char *argv[static argc + 1])
{
...
{
    return ct_runsuite_withargs(suite, 0, &ct_EmptyArgv);
}
...
/**
 Ensure the first argument of a variadic macro argument list is a string literal expression.
 ...
 The format string assumes consumption of a zero-width integer placeholder generated by a paired call to ct_va_rest.
 An empty argument list will generate a format expression consisting only of the zero-width integer placeholder.
 */
...
/**
 ...
 Assumes the placeholder zero will be consumed by the format string generated by ct_va_string.
 An empty argument list will generate a single argument consisting of the placeholder zero.
 */
